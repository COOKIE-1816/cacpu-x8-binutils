...
LINEINFO_NONE  = 0x00000,
LINEINFO_ORG   = 0x10000,
LINEINFO_BEGIN = 0x20000,
LINEINFO_END   = 0x40000
...
if len(sys.argv) < 2: 
    ...
    print('USAGE: asm.py <sourcefile> [-s[<tag>]]')
...
for i in range(len(lines)):
    for j in range(len(lines[i])):
        ...
        try: 
            ...
            print('err: ln ' + str(i+1) + ': undefined: \'' + lines[i][j] + '\'')
            exit(1)
